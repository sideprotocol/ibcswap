...
type MultiAssetDepositOrder struct {
	...
	SourceMakerLpToken      *types.Coin `protobuf:"bytes,6,opt,name=sourceMakerLpToken,proto3" json:"sourceMakerLpToken,omitempty"`
	DestinationTakerLpToken *types.Coin `protobuf:"bytes,7,opt,name=destinationTakerLpToken,proto3" json:"destinationTakerLpToken,omitempty"`
}
...
func (m *MultiAssetDepositOrder) GetSourceMakerLpToken() *types.Coin {
	if m != nil {
		return m.SourceMakerLpToken
	}
	return nil
}

func (m *MultiAssetDepositOrder) GetDestinationTakerLpToken() *types.Coin {
	if m != nil {
		return m.DestinationTakerLpToken
	}
	return nil
}
...
var fileDescriptor_b958a5b8f2d9fd58 = []byte{
	...
	,
}
...
func (m *MultiAssetDepositOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DestinationTakerLpToken != nil {
		{
			size, err := m.DestinationTakerLpToken.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.SourceMakerLpToken != nil {
		{
			size, err := m.SourceMakerLpToken.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MultiAssetDepositOrder) Size() (n int) {
	...
	if m.SourceMakerLpToken != nil {
		l = m.SourceMakerLpToken.Size()
		n += 1 + l + sovMarket(uint64(l))
	}
	if m.DestinationTakerLpToken != nil {
		l = m.DestinationTakerLpToken.Size()
		n += 1 + l + sovMarket(uint64(l))
	}
	return n
}
...
func (m *MultiAssetDepositOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceMakerLpToken", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SourceMakerLpToken == nil {
				m.SourceMakerLpToken = &types.Coin{}
			}
			if err := m.SourceMakerLpToken.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DestinationTakerLpToken", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DestinationTakerLpToken == nil {
				m.DestinationTakerLpToken = &types.Coin{}
			}
			if err := m.DestinationTakerLpToken.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
