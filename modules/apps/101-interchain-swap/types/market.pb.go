...
type InterchainLiquidityPool struct {
	...
	CreatorChainId        string       `protobuf:"bytes,7,opt,name=creatorChainId,proto3" json:"creatorChainId,omitempty"`
	EncounterPartyPort    string       `protobuf:"bytes,8,opt,name=encounterPartyPort,proto3" json:"encounterPartyPort,omitempty"`
	EncounterPartyChannel string       `protobuf:"bytes,9,opt,name=encounterPartyChannel,proto3" json:"encounterPartyChannel,omitempty"`
}
...
func (m *InterchainLiquidityPool) GetCreatorChainId() string {
	if m != nil {
		return m.CreatorChainId
	}
	return ""
}
...
var fileDescriptor_b958a5b8f2d9fd58 = []byte{
	...
	,
}
...
func (m *InterchainLiquidityPool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CreatorChainId) > 0 {
		i -= len(m.CreatorChainId)
		copy(dAtA[i:], m.CreatorChainId)
		i = encodeVarintMarket(dAtA, i, uint64(len(m.CreatorChainId)))
		i--
		dAtA[i] = 0x3a
	}
	if m.Status != 0 {
...
func (m *InterchainLiquidityPool) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CreatorChainId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CreatorChainId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
