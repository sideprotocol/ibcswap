...
var (
	...
	ErrFailedTakePool                 = errorsmod.Register(ModuleName, 1557, "failed to create pool")
	ErrMultipleAssetDepositNotAllowed = errorsmod.Register(ModuleName, 1558, "can't take other's deposit order")
	ErrSameChain                      = errorsmod.Register(ModuleName, 1557, "can't take operation in same chain")
)
