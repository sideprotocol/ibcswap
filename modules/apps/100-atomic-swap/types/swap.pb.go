...
type LimitOrder struct {
	...
	FillStatus        FillStatus   `protobuf:"varint,4,opt,name=fill_status,json=fillStatus,proto3,enum=ibc.applications.atomic_swap.v1.FillStatus" json:"fill_status,omitempty"`
...
func (m *OTCOrder) Reset()         { *m = OTCOrder{} }
func (m *OTCOrder) String() string { return proto.CompactTextString(m) }
...
func (m *OTCOrder) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OTCOrder.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OTCOrder) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OTCOrder.Merge(m, src)
}
func (m *OTCOrder) XXX_Size() int {
	return m.Size()
}
func (m *OTCOrder) XXX_DiscardUnknown() {
	xxx_messageInfo_OTCOrder.DiscardUnknown(m)
}

var xxx_messageInfo_OTCOrder proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*LimitOrder)(nil), "ibc.applications.atomic_swap.v1.LimitOrder")
	proto.RegisterType((*OTCOrder)(nil), "ibc.applications.atomic_swap.v1.OTCOrder")
}
...
var fileDescriptor_7ab3ff4471e3e52b = []byte{
	...
	,
}
...
func (m *LimitOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Takers) > 0 {
		for iNdEx := len(m.Takers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Takers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.FillStatus != 0 {
		i = encodeVarintSwap(dAtA, i, uint64(m.FillStatus))
		i--
		dAtA[i] = 0x20
	}
	if m.Status != 0 {
...
func (m *LimitOrder) Size() (n int) {
	...
	if m.FillStatus != 0 {
		n += 1 + sovSwap(uint64(m.FillStatus))
	}
	l = len(m.ChannelId)
	if l > 0 {
		n += 1 + l + sovSwap(uint64(l))
...
func (m *LimitOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FillStatus", wireType)
			}
			m.FillStatus = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FillStatus |= FillStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 6:
			...
			m.Takers = append(m.Takers, &SwapTaker{})
			if err := m.Takers[len(m.Takers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
...
func (m *OTCOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: OTCOrder: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OTCOrder: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
