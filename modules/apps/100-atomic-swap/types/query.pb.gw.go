...
var (
	...
	pattern_Query_Orders_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"ibc", "apps", "atomicswap", "v1", "orders"}, "", runtime.AssumeColonVerbOpt(true)))
)
